    ...
    <section className="select-test-category-step">
      <div className="select-test-category-step__container">
        <header className="select-test-category-step__header">
          ...
          <button onClick={getIssueTypesOfUser}>Get Issue Types of User</button>
          ...
          <h5 className="select-test-category-step__header__title">
            ...
            {totalCategories === 1 ? "category" : "categories"} with{" "}
            {totalTestCases} total test cases. Average of{" "}
            {avgTestCasesPerCategory} test{" "}
            {avgTestCasesPerCategory === 1 ? "case" : "cases"} per category.
